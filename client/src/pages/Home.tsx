        ...
        <section className="starfield aurora relative px-4 pb-16 pt-14 sm:px-6 sm:pb-24 sm:pt-20 lg:pt-24">
          <div className="container relative grid items-center gap-12 lg:grid-cols-[1fr_0.92fr] lg:gap-14">
            <div className="fade-up max-w-2xl">
              ...
              <p className="mt-5 max-w-xl text-[0.94rem] leading-7 text-muted-foreground">Interactive workshops, practical courses, expert-led bootcamps, and hands-on engineering projects for curious students in science, engineering, and technology.</p>
